<?php
	...
	// 글 정보 가져오기
	$result=mysql_query("SELECT * FROM callimania WHERE language = 'Korean' AND category = 'Sentence' ORDER BY RAND() LIMIT 1", $conn);
	$row=mysql_fetch_array($result);
?>

<div id="contents" align="center">
	<p class="tab">
		<label><a href="../word"><input type="radio" name="genType" /> 단어 생성</a></label>
		<label><a href="./"><input type="radio" name="genType" checked /> 문장 생성</a></label>
	</p> <!--// tab -->
