<?php
	...
	// 글 정보 가져오기
	$result=mysql_query("SELECT * FROM callimania WHERE language = 'English' AND category = 'Sentence' ORDER BY RAND() LIMIT 1", $conn);
	$row=mysql_fetch_array($result);
?>

<div id="contents" align="center">
	<p class="tab">
		<label><a href="../word"><input type="radio" name="genType" /> Word</a></label>
		<label><a href="./"><input type="radio" name="genType" checked /> Sentence</a></label>
	</p> <!--// tab -->
