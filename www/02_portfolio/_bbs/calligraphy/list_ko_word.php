<?php
	...
	$query = "SELECT * FROM callimania WHERE language = 'Korean' AND category = 'Word' ORDER BY id DESC LIMIT $no, $page_size";
	$result = mysql_query($query, $conn);

	// 총 게시물 수 를 구한다.
	$result_count=mysql_query("SELECT count(*) FROM callimania WHERE language = 'Korean' AND category = 'Word'", $conn);
...
<div id="contents">
	<p class="tab" align="center" style="width:900px; margin:0 auto 20px auto;">
		...
		<label><a href="./list_ko_word.php"><input type="radio" name="genType" checked /> Korean / Word</a></label>
