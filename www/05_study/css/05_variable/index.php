...
<div class="wrap">
	...
	<div id="intro">* CSS에 변수를 선언 (IE에서 사용불가)</div>
	<br />

	<h3><span>\</span> <b>C</b>ODE</h3>
	<div class="code">
		<pre>
		<code class="language-css">	:root { /* :root는 최상위 요소 (html 태그) 선택자 */
	--my-color : red;
	--my-font-size : 14px;
	}

	.color {color:var(--my-color);}
	.font-size {font-size:var(--my-font-size);}
		</code>
		</pre>
	</div>
	...
	<div id="result">
		<br />
		<p class="color">My Color</p>
		<p class="font-size">My Font Size</p>
	</div>
	<br /><br /><br />
	...
	:root {--my-color : red; --my-font-size : 32px;}
	.color {color:var(--my-color);}
	.font-size {font-size:var(--my-font-size);}
	</style>
